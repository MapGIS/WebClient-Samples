...
import { IGServer, IGServer2,ClientView, ClientAnalysis,ClientTheme,ClientDraw,ClientControl,ClientComponent,VectorTile, ElasticSearch, Spark } from './DetailConfig';
