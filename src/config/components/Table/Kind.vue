<template>
  ...
  >
    ...
    >
      <template slot-scope="scope">
        <div :class="['default',{'support': scope.row.mapboxgl === '支持'}, {'not-support': scope.row.mapboxgl === '不支持'}]">{{scope.row.mapboxgl === '支持'? '√': scope.row.mapboxgl === '不支持'? '×': '-'}}</div>
      </template>
    </el-table-column>
    <el-table-column
      prop="openlayers"
    ...
    >
      <template slot-scope="scope">
        <div :class="['default',{'support': scope.row.openlayers === '支持'}, {'not-support': scope.row.openlayers === '不支持'}]">{{scope.row.openlayers === '支持'? '√': scope.row.openlayers === '不支持'? '×': '-'}}</div>
      </template>
    </el-table-column>
    <el-table-column
      prop="cesium"
    ...
    >
      <template slot-scope="scope">
        <div :class="['default',{'support': scope.row.cesium === '支持'}, {'not-support': scope.row.cesium === '不支持'}]">{{scope.row.cesium === '支持'? '√': scope.row.cesium === '不支持'? '×': '-'}}</div>
      </template>
    </el-table-column>
  </el-table>
</template>
