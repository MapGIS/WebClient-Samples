...
&ensp;&ensp;&ensp;&ensp;该示例实现了属性条件查询矢量图层，高亮显示结果要素的功能，显示“世界政区”。
...
&ensp;&ensp;&ensp;&ensp;实例化查询参数对象`Zondy.Service.QueryByLayerParameter`，设置查询要素数目`recordNumber`、查询条件`where`;
