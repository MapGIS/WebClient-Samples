...
1. 打开地图文档：MapGIS 10打开地图文档，检查**数据图层Layer**的`参照系`
   ...
   <img src="../static/modules/mapboxgl/example-introduce/ogc/wmts_layer_crs.png" alt="图层参照系检查" style="zoom:40%;" />

2. 瓦片裁剪：

   <img src="../static/modules/mapboxgl/example-introduce/ogc/wmts_tile.png" alt="瓦片裁剪" style="zoom:40%;" />

3. 裁剪信息：地图文档**瓦片裁剪**信息

   设置**裁剪信息**：根据数据图层参照系选择**裁剪策略**

   <img src="../static/modules/mapboxgl/example-introduce/ogc/wmts_tile_cutinfo.png" alt="瓦片裁剪-裁剪信息" style="zoom: 50%;" />

   设置**图层信息**：

   <img src="../static/modules/mapboxgl/example-introduce/ogc/wmts_tile_layerinfo.png" alt="瓦片裁剪-图层信息" style="zoom:50%;" />

   设置**瓦片输出**：设置顽皮

   <img src="../static/modules/mapboxgl/example-introduce/ogc/wmts_tile_output.png" alt="瓦片裁剪-瓦片输出" style="zoom: 40%;" />

4. 瓦片服务发布：打开MapGIS IGServer，在服务器管理界面**发布瓦片**

   <img src="../static/modules/mapboxgl/example-introduce/ogc/wmts_tile_publish.png" alt="瓦片发布" style="zoom: 50%;" />

5. WMTS服务发布：

   <img src="../static/modules/mapboxgl/example-introduce/ogc/wmts_publish.png" alt="igserver" style="zoom:40%;" >

6. 前端脚本关键语法：

   <img src="../static/modules/mapboxgl/example-introduce/ogc/wmts_tile_capabilities.png" alt="igserver" style="zoom:50%;" />
   ...
   ```javascript
      ...
      map.on("load", function () {
         ...
         source: {
            type: "raster",
            tiles: [                
            "http://192.168.82.91:6163/igs/rest/ogc/beijing/WMTSServer?" +
                  "service=WMTS" +
                  "&request=GetTile" +
                  "&version=1.0.0" +
                  "&style=default" +
...
* Example:
  ```javascript
  http://192.168.82.91:6163/igs/rest/ogc/OGC_4326_CHINA_WMTS/WMTSServer?service=WMTS&request=GetTile&version=1.0.0&style=default&tilematrixSet=EPSG:4326_OGC_4326_CHINA_arcgis_GB&format=image/png&layer=OGC_4326_CHINA_WMTS&tilematrix=2&tilerow=1&tilecol=7
  ```
