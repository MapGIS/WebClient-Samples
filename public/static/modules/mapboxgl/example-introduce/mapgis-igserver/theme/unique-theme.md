...
&ensp;&ensp;&ensp;&ensp;本示例需要使用【include-mapboxgl-local.js】开发库实现，通过关键接口`Zondy.Service.ThemeOper()`实现 MapGIS 地图文档的`单值专题图`操作功能。
...
&ensp;&ensp;&ensp;&ensp;创建**专题图结构信息对象**，并将该对象存放数组中，执行专题图功能时使用，如`添加专题图`、`更新专题图`。重点内容：使用`Zondy.Object.Theme.CUniqueTheme()`实现**单值**专题图；
...
#### 2.【单值专题图图形信息类】`Zondy.Object.Theme.CUniqueTheme(opt_options)`
...
| 属性               | 类型                                                                                                                                                                        | 默认值 | 描述                                        |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------------------- |
| DefaultInfo        | <a target="_blank" href="http://webclient.smaryun.com/docs/mapboxgl/Zondy.Object.Theme.CThemeInfo.html" >Zondy.Object.Theme.<br/>CThemeInfo</a>                          | Null   | 缺省专题图的图形信息                        |
| Expression         | String                                                                                                                                                                      | Null   | 唯一字段表达式，来自图层的某个属性字段。    |
| UniqueThemeInfoArr | Array-[<br/><a target="_blank" href="http://webclient.smaryun.com/docs/mapboxgl/Zondy.Object.Theme.CUniqueThemeInfo.html" >Zondy.Object.Theme.<br/>CUniqueThemeInfo</a>] | Null   | 每段专题图的图形信息                        |
...
#### 4. 【区符号参数信息】`Zondy.Object.CRegInfo(opt_options)`
...
#### 5. 【专题图服务】`Zondy.Service.ThemeOper(opt_guid, opt_options)`
