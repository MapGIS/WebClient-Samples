...
| **属性**  | **类型**                                                                                                                                     | 描述                     |
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| ThemeInfo | <a href="http://webclient.smaryun.com/docs/mapboxgl/Zondy.Object.Theme.CThemeInfo.html" target="_blank">Zondy.Object.Theme.CThemeInfo</a> | 统一配置专题图的图形信息 |
