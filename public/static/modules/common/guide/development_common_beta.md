...
- @mapgis/webclient-common 库：`webclient-common-10.7.7.13\package\dist\webclient-common.min.js`以及`mapgis-client-for-javascript-all-v10.7.7.13\dist\cdn\zondyclient\webclient-common-resource`
...
从 10.7.7.13 版本开始，webclient-common 库新增了静态资源，因此在使用时需要执行以下额外的操作步骤：
...
从 @mapgis/webclient-common v17.7.7 版本开始，webclient-common 库增加了静态资源，因此在使用时需要执行以下两个额外的操作步骤：
